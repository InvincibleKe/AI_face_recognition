...
@sio.on('face_detect_response', namespace=name_space)
def on_message(msg):
...
sio.emit('face_detect', json.dumps({'stream': img_b64},cls=MyEncoder,indent=4), namespace=name_space)
print('4')
